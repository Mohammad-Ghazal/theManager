                    ...
                    <div class="form">
                        ...
                        <form action="/company/update/{{$company->id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="container-form">
                                <input type="text" placeholder="company name" name="company_name" value="{{$company->company_name}}">
                                @error("company_name")
                                <p style="color:red;">{{$message}}</p>
                                @enderror
                                <input type="text" placeholder="company email" name="company_email" value="{{$company->company_email}}">
                                @error("company_email")
                                <p style="color:red;">{{$message}}</p>
                                @enderror
                                <input type="text" placeholder="company website" name="company_website" value="{{$company->company_website}}">
                                @error("company_website")
                                <p style="color:red;">{{$message}}</p>
                                @enderror
                                <input type="file" name="company_logo" value="{{$company->company_logo}}">
                            </div>
                            @error("company_logo")
                            <p style="color:red;">{{$message}}</p>
                            @enderror
